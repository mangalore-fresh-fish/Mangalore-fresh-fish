        ...
        <div className="relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group">
          <div className="p-5 sm:p-16">
            <div className="inline-flex items-center gap-3 bg-green-300 text-green-600 pr-4 p-1 rounded-full text-xs sm:text-sm">
              ...
              All Stationery Delivered Directly to Your Desk.{" "}
              <ChevronRightIcon
            ...
            <Link
              href="/shop"
              className="bg-slate-800 text-white text-m py-2.5 px-7 sm:py-5 sm:px-12 mt-4 sm:mt-10 rounded-md hover:bg-slate-900 hover:scale-103 active:scale-95 transition inline-block"
            >
              Make it yours
            </Link>
          </div>
